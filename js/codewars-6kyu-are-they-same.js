...
RULES
    ...
    a or b might be nil or null or None or nothing (except in C++, Elixir, Haskell, PureScript, Pascal, Perl, R, 
    Rust, Shell).
...
function comp(array1, array2) {
    ...
    squareRootedList = array2.map((item) => {
        return Math.sqrt(item);
    });
    console.log(squareRootedList.sort((a, b) => a - b));
    console.log(array1.sort((a, b) => a - b));

    return (
        JSON.stringify(squareRootedList.sort((a, b) => a - b)) ===
        JSON.stringify(array1.sort((a, b) => a - b))
    );
}
